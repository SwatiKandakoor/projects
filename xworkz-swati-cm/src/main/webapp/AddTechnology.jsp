							...
							<div class="card-body p-5 text-center">
								...
								<div class="form-outline mb-4">
									<input type="text" id="name" class="form-control" name="name"
										placeholder="Name" /> <label class="form-label" for="name">Name</label>
								</div>
